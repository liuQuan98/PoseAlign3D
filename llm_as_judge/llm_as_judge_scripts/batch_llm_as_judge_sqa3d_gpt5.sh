...
EXECUTABLE=llm_as_judge/llm_judge_for_SQA3D_gpt5.py

specific_paths=("playground/predictions/finetune-3d-llava-lora/sqa3d" "playground/predictions/finetune-3d-llava-lora-PoseAlign-pc-cut03-noFlip/sqa3d")
