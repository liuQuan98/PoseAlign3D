...
EXECUTABLE=llm_as_judge/llm_judge_for_Scan2Cap_gpt5.py

specific_paths=("playground/predictions/finetune-3d-llava-lora/densecap_scanrefer" "playground/predictions/finetune-3d-llava-lora-PoseAlign-pc-cut03-noFlip/densecap_scanrefer")
